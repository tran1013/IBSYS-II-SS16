...
public class MenBikeController extends BaseProductionTabController {
    ...
    public void initUIComponents() {
        try {
            ...
            productionE31.setText(String.valueOf(
                    getProductionValueEParts("31", Integer.parseInt(productionP3.getText()), getQueueValue("3"),
                            Integer.parseInt(safetyE31.getText()), Integer.parseInt(stockE31.getText()),
                            Integer.parseInt(queueE31.getText()), Integer.parseInt(processE31.getText()))));
            ...
            productionE16.setText(String.valueOf(getProductionValueEParts("16",
                    Integer.valueOf(productionE31.getText()), Integer.parseInt(queueE16.getText()),
            ...
            productionE17.setText(String.valueOf(getProductionValueEParts("17",
                    Integer.valueOf(productionE31.getText()), Integer.parseInt(queueE17.getText()),
            ...
            productionE30.setText(String.valueOf(
                    getProductionValueEParts("30", Integer.valueOf(productionE31.getText()), getQueueValue("31"),
            ...
            productionE6.setText(String.valueOf(getProductionValueEParts("6", Integer.valueOf(productionE30.getText()),
            ...
            productionE12.setText(String.valueOf(
                    getProductionValueEParts("12", Integer.valueOf(productionE30.getText()), getQueueValue("30"),
            ...
            productionE29.setText(String.valueOf(
                    getProductionValueEParts("29", Integer.valueOf(productionE30.getText()), getQueueValue("30"),
            ...
            productionE9.setText(String.valueOf(getProductionValueEParts("9", Integer.valueOf(productionE29.getText()),
            ...
            productionE15.setText(String.valueOf(
                    getProductionValueEParts("15", Integer.valueOf(productionE29.getText()), getQueueValue("29"),
            ...
            productionE20.setText(String.valueOf(
                    getProductionValueEParts("20", Integer.valueOf(productionE29.getText()), getQueueValue("29"),
                            Integer.parseInt(safetyE20.getText()), Integer.parseInt(stockE20.getText()),
                            Integer.parseInt(queueE20.getText()), Integer.parseInt(processE20.getText()))));

            /*
             * setMainProductionList("3", Arrays.asList(productionP3,
             * productionE26, productionE31, productionE16, productionE17,
             * productionE30, productionE6, productionE12, productionE29,
             * productionE9, productionE15, productionE20));
             */
        } catch (Exception e) {
            logger.error(e);
            e.printStackTrace();
    ...
    public List<Item> setList() {
        List<Item> productionResultChild = setMainProductionList("3",
                Arrays.asList(productionP3, productionE26, productionE31, productionE16, productionE17, productionE30,
                        productionE6, productionE12, productionE29, productionE9, productionE15, productionE20));
