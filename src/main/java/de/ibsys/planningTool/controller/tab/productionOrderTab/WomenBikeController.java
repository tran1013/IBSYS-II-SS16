	...
	public void initUIThingsRandom() {
		try {
			...
			productionE26.setText(String.valueOf(
					getProductionValueEParts("26", getForeCastInformationProductLine("p2n"), getQueueValue("2"))));
			...
			productionE56.setText(String.valueOf(
					getProductionValueEParts("56", getForeCastInformationProductLine("p2n"), getQueueValue("2"))));
			...
			productionE16.setText(String.valueOf(
					getProductionValueEParts("16", Integer.valueOf(productionE56.getText()), getQueueValue("56"))));
			...
			productionE17.setText(String.valueOf(
					getProductionValueEParts("17", Integer.valueOf(productionE56.getText()), getQueueValue("56"))));
			...
			productionE5.setText(String.valueOf(
					getProductionValueEParts("5", Integer.valueOf(productionE55.getText()), getQueueValue("55"))));
			...
			productionE8.setText(String.valueOf(
					getProductionValueEParts("8", Integer.valueOf(productionE54.getText()), getQueueValue("54"))));
