    ...
    public void initUIThingsRandom() {
        try {
            ...
            productionE26.setText(String.valueOf(
                    getProductionValueEParts("26", getForeCastInformationProductLine("p2n"), getQueueValue("2"), Integer.parseInt(safetyE26.getText()))));
            ...
            productionE56.setText(String.valueOf(
                    getProductionValueEParts("56", getForeCastInformationProductLine("p2n"), getQueueValue("2"), Integer.parseInt(safetyE56.getText()))));
            ...
            productionE16.setText(String.valueOf(
                    getProductionValueEParts("16", Integer.valueOf(productionE56.getText()), getQueueValue("56"), Integer.parseInt(safetyE16.getText()))));
            ...
            productionE17.setText(String.valueOf(
                    getProductionValueEParts("17", Integer.valueOf(productionE56.getText()), getQueueValue("56"), Integer.parseInt(safetyE17.getText()))));
            ...
            productionE55.setText(String.valueOf(
                    getProductionValueEParts("55", Integer.valueOf(productionE56.getText()), getQueueValue("56"), Integer.parseInt(safetyE55.getText()))));
            ...
            productionE5.setText(String.valueOf(
                    getProductionValueEParts("5", Integer.valueOf(productionE55.getText()), getQueueValue("55"), Integer.parseInt(safetyE5.getText()))));
            ...
            productionE11.setText(String.valueOf(
                    getProductionValueEParts("11", Integer.valueOf(productionE55.getText()), getQueueValue("55"), Integer.parseInt(safetyE11.getText()))));
            ...
            productionE54.setText(String.valueOf(
                    getProductionValueEParts("54", Integer.valueOf(productionE55.getText()), getQueueValue("55"), Integer.parseInt(safetyE54.getText()))));
            ...
            productionE8.setText(String.valueOf(
                    getProductionValueEParts("8", Integer.valueOf(productionE54.getText()), getQueueValue("54"), Integer.parseInt(safetyE8.getText()))));
            ...
            productionE14.setText(String.valueOf(
                    getProductionValueEParts("14", Integer.valueOf(productionE54.getText()), getQueueValue("54"), Integer.parseInt(safetyE14.getText()))));
            ...
            productionE19.setText(String.valueOf(
                    getProductionValueEParts("19", Integer.valueOf(productionE54.getText()), getQueueValue("54"), Integer.parseInt(safetyE19.getText()))));
